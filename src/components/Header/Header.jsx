        ...
        <div className="container">
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to='/' id="hero"><h1 className='text-gray-700 '>A<span>dnan</span></h1></Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                ...
                <div className="sp-phone">
                  ...
                  <a href="tel:9747049193">
                  <div className="sp-phone-no">+91 9747 049 193</div></a>
                </div>
              </div>
            </div>
          </div>
